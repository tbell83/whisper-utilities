...
parser.add_argument('-p', action='store', dest='path', type=str, default='/opt/graphite/storage/whisper/applications')
...
print table
print '{} unused metrics totalling {} GB'.format(totalMetrics, totalSize / 1024 ** 3)
